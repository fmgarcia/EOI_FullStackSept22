...
public class EjemploListas {
	...
	public static void reemplazar() {
		...
		System.out.println("Introduzca la cadena a buscar: ");
		String cadenaBuscada = sc.nextLine();
		System.out.println("Introduzca la cadena para reemplazar: ");
	...
	public static void ejemplosCondicionalesListas() {
		...
		// ejemplo retainAll
		meses = new ArrayList<String>(Arrays.asList("Enero", "febrero", "Marzo", "Abril", "Mayo", "Junio",
				"Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"));
	...
	public static void ejercicio1() {
		...
		numeros.add(50); // 10, 20, 30, 40 , 50
		numeros.add(60); // 10, 20, 30, 40 , 50, 60
		//numeros.removeIf(n->n==20); // 10, 30, 40 , 50, 60
		numeros.remove(numeros.indexOf(20)); // 10, 30, 40 , 50, 60
		numeros.add(1,25); // 10, 25, 30, 40 , 50, 60
		numeros.add(2,26); // 10, 25, 26, 30, 40 , 50, 60
